    ...
    app = (Vue.component("vue-cabinet-button", {
        ...
        computed: {
            setBtnDisabled: function() {
                return !!(this.isCheckboxVisible && this.checkbox && this.checkbox2 || !this.isCheckboxVisible)
            },
            ...
            iduser: function () {
                var s = window.location.search;
                s = s.match(new RegExp('iduser' + '=([^&=]+)'));
                return s ? s[1] : false;
            },
            payaction: function () {
                var s = window.location.search;
                s = s.match(new RegExp('payaction' + '=([^&=]+)'));
                return s ? s[1] : false;
            }
        },
        methods: {
